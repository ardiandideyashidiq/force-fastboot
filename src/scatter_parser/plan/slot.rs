...
pub(crate) fn inherited_image_source_for_slot_b<'a>(
...
pub(crate) fn inherited_action_reason(
    base_reason: String,
...
pub(crate) fn expand_requested_names(
    requested: &[String],
...
pub(crate) fn synthesize_slot_actions_if_needed(
...
fn slot_synthesized_action(
    ...
    let (image, warnings) = super::image::recheck_synthesized_image(source.image.clone(), target);
    FlashAction {
...
pub(crate) fn check_incomplete_slots(
    selected_parts: &[ScatterPartition],
    actions: &[FlashAction],
